...
export function CreateProjectDialog({ isOpen, onOpenChange, trigger }: CreateProjectDialogProps) {
  ...
  const handleCreateProject = async (values: Omit<Project, "id">, { resetForm }: any) => {
    setIsLoading(true)
    try {
      // Simulate API call
      ...
      console.log("Project creation attempt:", values)
    ...
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>Create a new project to organize your features and test cases.</DialogDescription>
        </DialogHeader>
        <Formik initialValues={projectInitialValues} validationSchema={projectValidationSchema} onSubmit={handleCreateProject}>
          {({ isSubmitting }) => (
